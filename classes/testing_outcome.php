...
class qtype_coderunner_testing_outcome {
    ...
    public function is_precheck(question_attempt $qa=null) {
        if (isset($this->isprecheck)) {
            ...
            // Rendering a legacy outcome. Render using the logic from the legacy version
            // (which is wrong in the event that the quiz has closed. The test
            // should have included && !$qa->get_state()->is_finished().
