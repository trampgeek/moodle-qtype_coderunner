...
$string['feedback_default'] = 'Use default';
$string['feedback_show'] = 'Force show';
$string['feedback_hide'] = 'Force hide';
$string['feedback_help'] = 'Choose \'Use default\' to allow quiz settings to control display of the result table, \'Force show\' to show the result table regardless and \'Force hide\' to hide it regardless';
