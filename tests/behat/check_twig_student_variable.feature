...
Feature: Check the STUDENT Twig variable allows access to current username
  To check the STUDENT Twig variable works
  As a teacher
  I should be able to write a function that prints my username
  And it should be marked right
  ...
  Scenario: Preview the STUDENT variable function question and check it is marked right
