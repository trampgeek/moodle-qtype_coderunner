@questiontype @questiontype_coderunner @javascript @showdifferences
...
Scenario: As a teacher submitting a wrong answer to a question preview, I should see the Show differences button and it should work
    ...
    And I should not see highlighted "49"
    And I should not see highlighted "12345"
    And I press "Show differences"
    And I should see highlighted "49"
    And I should see highlighted "12345"
