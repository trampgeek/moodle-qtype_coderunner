...
/**
 * This script, which takes mandatory contextid, quizid, and quizname
 * parameters and an option tag to be added all CodeRunner questions in the given
 * quiz.
...
echo "<p>Tagging all questions in quiz <em>$quizname</em></p>\n";
...
if (empty($tag)) {
    ...
    echo "<label for='tagvalue'>Tag to add to all questions in this quiz: </label>\n";
